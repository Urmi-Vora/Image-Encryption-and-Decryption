...
with open("Project3\\key.key", 'wb') as f:
    f.write(key)

print("Key has been generated and saved.")

#Encrypting the image
with open("Project3\\key.key", 'rb') as f:
    key = f.read()
...
with open(r"Project3\test.png", 'rb') as f:
    photo = f.read()
...
with open("Project3\\encrypted_image.png", 'wb') as locked_photo_file:
...
with open("Project3\\encrypted_image.png", 'rb') as f:
    locked_photo = f.read()
...
with open("Project3\\decrypted_image.png", 'wb') as unlocked_photo_file:
